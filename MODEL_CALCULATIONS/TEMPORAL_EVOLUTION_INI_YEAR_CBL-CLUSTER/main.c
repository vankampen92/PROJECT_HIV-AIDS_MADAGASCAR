...
/* This is the same code as in
   ...
   -Fn 2 -F0 Antananarivo -F1 2001

   or

   -Fn 3 -F0 Antananarivo -F1 2001 -F2 Sigmoidal_C1

   where Sigmoidal_C1 is the type of hypothesis being tested, for example.
   ...
   B. Parameters are searched under the hypothesis of ratio of female
   sexual workers to total female population following a sigmoidal curve
   with a break point in 2011.0 and smoothness parameters 0.1 (for *Sigmoidal.dat files, or
   with given break point and smoothness parameters for *Sigmoidal_C?.dat type of files).
   This estimates are generated in ./OBSERVED_DATA_FILES_PREPARATION and resulting files
   ...
   /- i1 17 -u1 0.0 -U1 100.0
   / -G0 1  -G1 3 -tn 17 -t0 2000.0 -t1 2016.0 -t4 1 -xn 0 -xR 1  // Arguments Controling Numerical Integration
   / -DP 5  -DC 0 -D0 0 -D1 4 -D2 0 -P0 13 -a0 0  -P1 2 -a1 0  -P2 3 -a2 0  -P3 4 -a3 0 -P4 22 -a4 0// Arguments controling type of time dependence of model parameters.
   / -Fn 2 -F0 Anatananaribo -F1 2001

   . ~$ ./X2W2SILD-YSILD -y0 1 -sT 1.0E-04 -sN 300 -sP 12  -I0 21 -H21 1.0  -m0 0.5 -M0 1.5 -A0 0.01   -I1 0 -H0 100.0 -m1 0.0 -M1 200.0 -A1 0.1  -I2 8 -H8 50.0 -m2 0.0 -M2 100.0 -A2 0.1   -I3 12 -H12 9.0  -m3 1.0 -M3 20.0  -A3 0.01   -I4 7 -H7 9.0 -m4 1.0 -M4 99.0 -A4 0.01   -I5 16 -H16 0.2 -m5 0.0 -M5 0.99 -A5 0.01 -I6 17 -H17 0.6 -m6 0.0 -M6 0.99 -A6 0.01 -I7 1 -H1 0.03 -m7 0.0 -M7 0.1 -A7 0.001  -I8 9 -H9 0.01 -m8 0.0 -M8 0.1 -A8 0.001   -I9 5 -H5 1.5 -m9 0.0 -M9 10.0 -A9 0.1   -I10 6 -H6 0.2 -m10 0.0 -M10 1.0 -A10 0.01   -I11 15 -H15 10.0 -m11 1.0 -M11 100.0 -A11 0.1  -n 3 -v0 6 -v1 4 -v2 14 -en 0 -eP0 17 -eV 0.01 -iP 0 -i0 9 -u0 0.0 -U0 10000.0 -i1 17 -u1 0.0 -U1 10000.0 -i2 1 -u2 0.0 -U2 10000 -i3 2 -u3 0.0 -U3 10000 -i4 3 -u4 0.0 -U4 10000 -G0 1 -G1 3 -tn 17 -t0 2000.0 -t1 2016.0 -t4 1 -xn 0 -xR 1 -DP 5  -DC 0 -D0 0 -D1 4 -D2 1 -P0 13 -a0 0  -P1 2 -a1 0  -P2 3 -a2 0  -P3 4 -a3 0 -P4 22 -a4 0 -tE 2.0 -tR 15 -Fn 2 -F0 Anatananaribo -F1 2001

   The same execution without window graphical output (-NW):

   . ~$ ./X2W2SILD-YSILD-NW -y0 1 -sT 1.0E-04 -sN 300 -sP 12  -I0 21 -H21 1.0  -m0 0.5 -M0 1.5 -A0 0.01   -I1 0 -H0 100.0 -m1 0.0 -M1 200.0 -A1 0.1  -I2 8 -H8 50.0 -m2 0.0 -M2 100.0 -A2 0.1   -I3 12 -H12 9.0  -m3 1.0 -M3 20.0  -A3 0.01   -I4 7 -H7 9.0 -m4 1.0 -M4 99.0 -A4 0.01   -I5 16 -H16 0.2 -m5 0.0 -M5 0.99 -A5 0.01 -I6 17 -H17 0.6 -m6 0.0 -M6 0.99 -A6 0.01 -I7 1 -H1 0.03 -m7 0.0 -M7 0.1 -A7 0.001  -I8 9 -H9 0.01 -m8 0.0 -M8 0.1 -A8 0.001   -I9 5 -H5 1.5 -m9 0.0 -M9 10.0 -A9 0.1   -I10 6 -H6 0.2 -m10 0.0 -M10 1.0 -A10 0.01   -I11 15 -H15 10.0 -m11 1.0 -M11 100.0 -A11 0.1  -n 3 -v0 6 -v1 4 -v2 14 -en 0 -eP0 17 -eV 0.01 -iP 0 -i0 9 -u0 0.0 -U0 10000.0 -i1 17 -u1 0.0 -U1 10000.0 -i2 1 -u2 0.0 -U2 10000 -i3 2 -u3 0.0 -U3 10000 -i4 3 -u4 0.0 -U4 10000  -tn 17 -t0 2000.0 -t1 2016.0 -t4 1 -xn 0 -xR 1 -DP 5  -DC 0 -D0 0 -D1 4 -D2 1 -P0 13 -a0 0  -P1 2 -a1 0  -P2 3 -a2 0  -P3 4 -a3 0 -P4 22 -a4 0 -tE 2.0 -tR 15 -Fn 2 -F0 Antananarivo -F1 2001
   ...
   and resulting files are *_Sigmoidal.dat files (or *_Sigmoidal_C?.dat files). Notice this type
   of sigmoidal hypothesis is specified at command line:

   -Fn 3 -F0 Antananarivo -F1 2001 -F2 Sigmoidal

   (or -Fn 3 -F0 Antananarivo -F1 2001 -F2 Sigmoidal_C1, for example)
   ...
   . ~$ ./X2W2SILD-YSILD -y0 1 -sT 1.0E-04 -sN 300 -sP 12  -I0 21 -H21 1.0 -m0 0.8  -M0 1.2 -A0 0.01 -I1 0 -H0 100.0  -m1 96.0 -M1 120.0 -A1 0.1  -I2 8 -H8 100.0  -m2 96.0 -M2 120.0  -A2 0.1  -I3 12 -H12   9  -m3 1.0 -M3 19.0  -A3 0.01  -I4 7  -H7  9.0  -m4 0.0 -M4 99.0 -A4 0.01  -I5 16 -H16 0.2   -m5 0.0  -M5 0.99 -A5 0.01  -I6 17 -H17 0.5 -m6 0.0 -M6 0.99 -A6 0.01   -I7 1 -H1 0.001  -m7 0.0 -M7 0.005 -A7 0.0001   -I8 9 -H9 0.0005 -m8 0.0 -M8 0.001 -A8 0.0001   -I9 5 -H5 1.5  -m9 0.5 -M9 4.0 -A9 0.01     -I10 6 -H6 0.1   -m10 0.05 -M10 0.20 -A10 0.01   -I11 15 -H15 10.0 -m11 1.0 -M11 50.0 -A11 0.1   -n 3 -v0 6 -v1 4 -v2 14 -en 0 -eP0 17 -eV 0.2 -iP 0 -i0 9 -u0 0.0 -U0 10000.0 -i1 17 -u1 0.0 -U1 10000.0 -i2 1 -u2 0.0 -U2 10000 -i3 2 -u3 0.0 -U3 10000 -i4 3 -u4 0.0 -U4 10000 -G0 1 -G1 3 -tn 17 -t0 2000.0 -t1 2016.0 -t4 1 -xn 0 -xR 1 -DP 5  -DC 0 -D0 0 -D1 4 -D2 1 -P0 13 -a0 0  -P1 2 -a1 0  -P2 3 -a2 0  -P3 4 -a3 0 -P4 22 -a4 0 -tE 2.0 -tR 150 -Fn 3 -F0 Antananarivo -F1 2001 -F2 Sigmoidal

   No graphical output (-NW):
...
int main(int argc, char **argv)
{
  ...
  if (No_of_FILES < 3) FILE_LABEL = (char *)calloc(100, sizeof(char) );
  ...
  if( SIGMOIDAL == 1 ) {
    ...
    if (No_of_FILES < 3) {
      pF = strcat(FILE_LABEL, "Sigmoidal");
    }
  }
  else {
    ...
    Demographic_Parameters_Index[4] = 20;
    if (No_of_FILES < 3) {
      pF = strcat(FILE_LABEL, "");
    }
  }

  if( No_of_FILES == 3 ) FILE_LABEL = Name_of_FILE[2];
...
#include <gsl_random_number_Setup.c>
  ...
  char * City_Names_All[] = { "Antananarivo",  "Antsiranana",
			      "Mahajanga",     "Toamasina",
  ...
  for (i=0; i<No_of_CITIES_MAX; i++) City_Names[i] = City_Names_All[i];

  int No_of_CITIES   = 1;   // No_of_CITIES_MAX;
  ...
  int No_of_INITIAL_YEARS  = 1;  // No_of_INITIAL_YEARS_MAX;
  ...
  for(k = 0; k<No_of_CITIES; k++) {
    ...
    pF = strcat(DEMO_PARAMETER_SET[k], "_");
    pF = strcat(DEMO_PARAMETER_SET[k], FILE_LABEL);
    pF = strcat(DEMO_PARAMETER_SET[k], "_Ordered.dat");
  }
  /*     E N D : ------------------------------------------------------------------------ */
  ...
  for(k = 0; k<No_of_CITIES; k++)
    ...
    for(n=0; n < No_of_INITIAL_YEARS; n++) { // For each introduction time
      ...
      Year[0]='\0'; sprintf( Year, "%s", Year_List[n] );
      ...
      pF = strcat(LIKELIHOOD_VALUES[k], "_");
      pF = strcat(LIKELIHOOD_VALUES[k], FILE_LABEL);
      pF = strcat(LIKELIHOOD_VALUES[k], ".dat");
      ...
      pF = strcat(PARAMETER_SET_FILE[k], "_");
      pF = strcat(PARAMETER_SET_FILE[k], FILE_LABEL);
      pF = strcat(PARAMETER_SET_FILE[k], ".dat");
	...
	if(key < OUTPUT_VARIABLES_GENUINE)
      ...
      pF = strcat(OBSERVED_DATA_FILE[k], "_Exponential.dat");

      /* I_Time = I_Time_Total - n; */
      /* Time_0 = 2000.0 + n;       */

      Time_0 = atof(Year_List[n]);
      Time_1 = 2016.0;
      I_Time = (int)(Time_1 - Time_0 + 1.0);
...
#include <include.Time_Dependence_Control.default.aux.c>
  ...
  if(No_of_FILES < MAX_No_of_FILES) {
    free(City_Names);
    for (i=0; i<No_of_INITIAL_YEARS; i++) free( Year_List[i] );
    free(Year_List);
  }
#endif

  if (No_of_FILES < 3) free (FILE_LABEL);
