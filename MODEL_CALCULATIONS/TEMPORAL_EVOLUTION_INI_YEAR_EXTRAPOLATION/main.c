...
#include <gsl_random_number_Setup.c>
  ...
  /* 	if( i == (SUB_OUTPUT_VARIABLES-3) )  Table.CPG->CPG_SCALE_Y   =  1; */
  /* 	if( i == (SUB_OUTPUT_VARIABLES-3) )  Table.CPG->CPG_RANGE_Y_0 =  0.0; */
  /* 	if( i == (SUB_OUTPUT_VARIABLES-3) )  Table.CPG->CPG_RANGE_Y_1 =  1.0; */
	
  /* 	if( i >= (SUB_OUTPUT_VARIABLES-2) )  Table.CPG->CPG_SCALE_Y   =  1; */
  /* 	if( i >= (SUB_OUTPUT_VARIABLES-2) )  Table.CPG->CPG_RANGE_Y_0 =  0.0; */
  /* 	if( i >= (SUB_OUTPUT_VARIABLES-2) )  Table.CPG->CPG_RANGE_Y_1 =  1.0; //0.5 */
